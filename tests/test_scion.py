...
class TestSCION(unittest.TestCase):
    ...
    def test_dissect(self):
        ...
        packet3 = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00E\x00\x00h<\xfb@\x00@\x11\xff\x80\x7f\x00\x00\x04\x7f\x00\x00\x05\xc3P\xc3P\x00T\xfen\x00\x00\x00\x01\x11\x11\x00\x08\x02@\x00\x00\x00\x01\xff\x00\x00\x00\x01\x11\x00\x01\xff\x00\x00\x00\x01\x10\x00\x02\x00\x00\x7f\x00\x00\x0b\x01\x00\x9d\xaa`\xb3\xe5l\x00?\x00\x00\x00\x01I\x86\x17h\xd7\x15\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\xc8\x00\x00\x00\x08\xff\xe3'
        p = Ether(packet3)
